    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12 md:py-20">
        <div className="container max-w-xl text-center">
          ...
          <p className="text-muted-foreground mb-8">Geben Sie Ihre Bestellnummer und E-Mail-Adresse ein, um den Status Ihrer Bestellung zu überprüfen.</p>

          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            <div>
              <label className="text-sm font-medium text-foreground mb-1 block">Bestellnummer *</label>
              <input type="text" maxLength={50} placeholder="z.B. EC-20260327-001" className="w-full border rounded-md px-3 py-2 text-sm bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" value={orderNumber} onChange={(e) => setOrderNumber(e.target.value)} />
            ...
            <div>
              ...
              <input type="email" maxLength={255} placeholder="ihre@email.de" className="w-full border rounded-md px-3 py-2 text-sm bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" value={email} onChange={(e) => setEmail(e.target.value)} />
          ...
          {searched && (
            <div className="mt-8 bg-muted/50 border rounded-lg p-6 text-left">
              ...
              <div className="space-y-3">
                {[
                  { step: "Bestellung aufgegeben", done: true, date: "27.03.2026" },
                  { step: "Zahlung bestätigt", done: true, date: "27.03.2026" },
                  { step: "In Bearbeitung", done: true, date: "28.03.2026" },
